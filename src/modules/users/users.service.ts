  ...
  async findAll(
    ...
    const qb = this.userRepository
      ...
      .select([
        ...
        'array_agg(DISTINCT follows.nickname) as "followsNames"',
        'array_agg(DISTINCT follows.address) as "followsAddresses"',
        'array_agg(DISTINCT followers.id) as "followersId"',
        'array_agg(DISTINCT followers.nickname) as "followersNames"',
        'array_agg(DISTINCT followers.address) as "followersAddresses"',
